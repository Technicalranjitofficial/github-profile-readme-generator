...
const AddOns = ({addOns,onCheckAddons}) => {
  return (
    <div className="mt-2 text-slate-300 flex flex-col gap-2">
      <div onClick={()=>onCheckAddons('visitorBadge')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('twiterBadge')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('trophy')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('githubProfileStats')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('showMemes')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('showStreakStats')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
      ...
      <div onClick={()=>onCheckAddons('showMostLanguageUsed')} className="w-full border-2 border-slate-800 flex flex-row gap-1 py-3 hover:bg-slate-700 cursor-pointer">
